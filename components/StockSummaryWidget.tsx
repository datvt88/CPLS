...
export default function StockSummaryEvaluationWidget({ symbol }: StockSummaryEvaluationWidgetProps) {
    ...
    useEffect(() => {
        ...
        const performAnalysis = async () => {
            ...
            try {
                ...
                console.error('❌ Error performing Summary analysis:', err)
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div className="bg-gradient-to-br from-cyan-900/20 to-blue-900/20 rounded-lg p-4 sm:p-5 border border-cyan-700/30">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        ...
                        <div className="w-full bg-gray-700 rounded-full h-3">
                            <div
                                className={`h-3 rounded-full transition-all ${analysis.shortTerm.signal === 'MUA'
                                        ? 'bg-green-600'
                ...
                <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 rounded-lg p-4 sm:p-5 border border-purple-700/30">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        ...
                        <div className="w-full bg-gray-700 rounded-full h-3">
                            <div
                                className={`h-3 rounded-full transition-all ${analysis.longTerm.signal === 'MUA'
                                        ? 'bg-green-600'
