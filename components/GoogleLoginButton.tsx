...
export default function GoogleLoginButton({ onError, className }: GoogleLoginButtonProps) {
  ...
  return (
    <button
      ...
      className={
        className ||
        'w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-800 font-semibold py-3 px-4 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed border border-gray-300'
      }
    >
      {loading ? (
