...
import { askGemini, checkConnection } from '@/app/chat/chat-gemini'
...
export default function ChatRoom() {
  ...
  // 1. Kiểm tra trạng thái Bot khi vào phòng
  useEffect(() => {
    checkConnection().then((isConnected) => {
      setBotStatus(isConnected ? 'online' : 'offline')
    })
  }, [])
